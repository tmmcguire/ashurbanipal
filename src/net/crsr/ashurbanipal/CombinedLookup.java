...
public class CombinedLookup {
	...
	public static List<Pair<Map<String,Double>,Map<String,Integer>>> matchingPosAndNouns(PosStore posStore, WordStore nouns, List<Pair<String,String>> formats) {
	...
	public static List<Pair<Double,String>> nearestNeighbors(PosStore posStore, WordStore nounStore, Pair<Map<String,Double>,Map<String,Integer>> initial) {
